...
namespace SecurityConsole {
    ...
    public partial class SampleDBDataSet : global::System.Data.DataSet {
        ...
        public partial class PeopleDataTable : global::System.Data.TypedTableBase<PeopleRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PeopleRow AddPeopleRow(int Id, string email) {
...
namespace SecurityConsole.SampleDBDataSetTableAdapters {
    ...
    public partial class PeopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[People] ([Id], [email]) VALUES (@Id, @email);\r\nSELECT Id, emai" +
                "l FROM People WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[People] SET [Id] = @Id, [email] = @email WHERE (([Id] = @Original_I" +
                "d));\r\nSELECT Id, email FROM People WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SecurityConsole.Properties.Settings.Default.SampleDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, email FROM dbo.People";
        ...
        public virtual int Fill(SampleDBDataSet.PeopleDataTable dataTable) {
        ...
        public virtual SampleDBDataSet.PeopleDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SampleDBDataSet.PeopleDataTable dataTable = new SampleDBDataSet.PeopleDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SampleDBDataSet.PeopleDataTable dataTable) {
        ...
        public virtual int Insert(int Id, string email) {
        ...
        public virtual int Update(int Id, string email, int Original_Id) {
        ...
        public virtual int Update(string email, int Original_Id) {
            return this.Update(Original_Id, email, Original_Id);
        }
    }
